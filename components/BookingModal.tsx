...
export default function BookingModal() {
    ...
    const handleSubmit = (e: FormEvent) => {
        ...
        const message =
            ...
            `*Fecha deseada:* ${formData.date}%0A` +
            `*Hora:* ${formData.time}`;
                    ...
                    <motion.div
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="relative group">
                                    <span className="material-symbols-outlined absolute left-4 top-3.5 text-slate-600 group-focus-within:text-[#0258d5] transition-colors">smartphone</span>
                                    <input
                                        required
                                        name="phone"
                                        onChange={handleChange}
